...
> This is a **lite** demo. The full reference-driven multi-agent framework — including retrieval over PaperBananaBench, statistical-plot generation, parallel candidate fan-out, and high-resolution polishing — lives in the [upstream PaperVizAgent repo](https://github.com/google-research/papervizagent). Please cite the [PaperBanana paper](https://huggingface.co/papers/2601.23265) when using this work.
